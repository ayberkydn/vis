import torch, torchvision, wandb, kornia, logging, random, timm
...
def get_images_log_dict(
    in_layer,
):
    log_imgs = in_layer.get_images()
    classes = in_layer.get_classes()
    wandb_imgs = [
        wandb.Image(img, caption=imagenet_class_name_of(in_layer.get_classes()[n]))
